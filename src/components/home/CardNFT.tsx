...
const CardNFT = ({ image, name, value }: ICollectionType) => {
  return (
    <div className="h-fit w-full rounded-[20px] border border-neutral-100 p-3">
      ...
      <button className="mt-4 w-full rounded-xl border border-neutral-800 bg-transparent py-[10px] text-base font-semibold text-neutral-800 hover:bg-neutral-50">
        Place a Bid
      </button>
    </div>
  )
